...
\end{advice}
\begin{proof}
Знаем для любой случайной величины
\[
    \forall \varepsilon > 0 \  \exists A: P\left(\abs{\xi} > \frac{A}{2}\right) < \varepsilon
\]
\[
    \forall \varepsilon > 0 \ \exists A \ \exists N \ \forall n > N: P\left(\abs{\xi_{n}} > A\right) \leq P\left(\abs{\xi - \xi_{n}} + \abs{\xi} > A\right) \leq 
\]
\[
    \leq P\left(\abs{\xi - \xi_{n}} > \frac{A}{2} \ or \  \abs{\xi} > \frac{A}{2}\right) \leq P\left(\abs{\xi - \xi_{n}} > \frac{A}{2}\right) + P\left(\abs{\xi} > \frac{A}{2}\right) < \varepsilon
\]
